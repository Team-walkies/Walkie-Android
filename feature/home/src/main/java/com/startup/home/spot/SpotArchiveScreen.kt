...
internal fun SpotArchiveScreen() {
    ...
    SpotArchiveCalendarBottomModal({}, sheetState)
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun SpotArchiveCalendarBottomModal(
    onClickCancel: () -> Unit,
    ...
    WalkieTheme {
        ModalBottomSheet(
            ...
            SpotArchiveCalendarBottomModalContent(onClickDate = {})
        }
    }
}
...
@Composable
private fun SpotArchiveCalendarBottomModalContent(
    selectDateTime: LocalDate = LocalDate.now(),
...
/** 날짜가 들어갈 컴포넌트 */
@Composable
private fun RowScope.LabelText(
    date: LocalDate?,
    isSelected: Boolean,
